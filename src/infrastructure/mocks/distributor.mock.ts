...
const makeProduct = (id: number, nombre: string): Product => ({
  id,
  nombre,
  precio: 0,
  stock: 0,
...
export const DISTRIBUTORS_MOCK: Distributor[] = [
  { id: 1, createdAt: '2024-01-01T00:00:00Z', name: 'Vet Salud' },
  { id: 2, createdAt: '2024-01-05T00:00:00Z', name: 'Mascotas Center' }
]

export const DISTRICTS_MOCK: District[] = [
  { id: 1, createdAt: '2024-01-01T00:00:00Z', name: 'San Isidro' },
  { id: 2, createdAt: '2024-01-01T00:00:00Z', name: 'Miraflores' }
]

const mockProducts: Product[] = [
  makeProduct(201, 'Antipulgas'),
  makeProduct(202, 'Alimento Premium'),
  makeProduct(203, 'Vitaminas')
]
