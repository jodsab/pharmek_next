      ...
      <div className="footer_container content">
        ...
        <div>
          ...
          <div className="buttons_socials">
            <Link href={SOCIAL_NETWORKS.tiktok.url} target="_blank" rel="noreferrer" aria-label="TikTok">
              <FaTiktok />
            </Link>
            <Link href={SOCIAL_NETWORKS.facebook.url} target="_blank" rel="noreferrer" aria-label="Facebook">
              <FaFacebookF />
            </Link>
            <Link href={SOCIAL_NETWORKS.instagram.url} target="_blank" rel="noreferrer" aria-label="Instagram">
              <FaInstagram />
            </Link>
          </div>
        </div>
