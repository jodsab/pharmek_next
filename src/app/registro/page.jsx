      ...
      <div className="login_container">
        <div className="login_area p-10">
          ...
          <form onSubmit={onSubmit} className="w-200">
            ...
            {/* full_name */}
            <label className="text-slate-500 mb-2 block text-sm">Nombre completo:</label>
            <input
              type="text"
              {...register('full_name', {
            ...
            {/* celular */}
            <label className="text-slate-500 mb-2 block text-sm">Celular:</label>
            <input
              type="text"
            ...
            {/* confirmPassword */}
            <label className="text-slate-500 mb-2 block text-sm">Confirma tu contraseña:</label>
            <input
              type="password"
