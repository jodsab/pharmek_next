...
const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    const loadTextPlugin = () => {
      if (typeof window.gsap !== 'undefined' && typeof window.gsap.TextPlugin === 'undefined') {
  ...
  return (
    ...
    >
      ...
      <img
        ...
        onError={e =>
          (e.target.src = 'https://placehold.co/400x300/F5F5F5/008556?text=Error%20Imagen')
        } // Fallback
      />
      <img
        ref={image2Ref}
        ...
        onError={e =>
          (e.target.src = 'https://placehold.co/400x300/F5F5F5/1226aa?text=Error%20Imagen')
        } // Fallback
      />
