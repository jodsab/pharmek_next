...
export const EmailTemplate = ({ ...props }) => {
  ...
  return (
    <div>
      ...
      <p>
        Somos Pharmek y estamos felices que hayas decidido contactarte con nosotros, pronto nos
      ...
      <p>
        ...
        <strong>{Email}</strong>, Phone: <strong>{Phone}</strong>, Edad: <strong>{Edad}</strong>,
        Asunto: <strong>{Asunto}</strong>, Ocupation:
