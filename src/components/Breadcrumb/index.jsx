...
// Aunque no lo usemos directamente aquí, es buena práctica si los enlaces pudieran ir "atrás" o ser dinámicos
          ...
          return (
            <li
              ...
              className={`flex items-center ${
                isLastItem ? 'text-gray-800 dark:text-gray-200 font-semibold' : ''
              }`}
            >
              ...
              {!isLastItem && item.href ? (
                ...
                <span
                  className={`${isLastItem ? 'truncate max-w-xs sm:max-w-sm md:max-w-md' : ''}`}
                >
                  {' '}
              ...
              {!isLastItem && <span className="mx-2 text-gray-500 dark:text-gray-500">&gt;</span>}
            </li>
          )
        })}
      </ol>
