...
export function normalizeError(error) {
  ...
  if (code === "23505") {
    if (msg.includes("usuarios_celular_key"))
      return errorMessages["23505:usuarios_celular_key"];
    if (msg.includes("usuarios_correo_key"))
      return errorMessages["23505:usuarios_correo_key"];
  }
